const noPoster = `https://image.shutterstock.com/image-vector/stop-sign-set-icon-traffic-600w-1949522347.jpg`;
      ...
      ({
        ...
        return `<li  class="movie-card-item">
          ...
          <div class="movie-card-item__info">
            ...
            <p class="movie-card-item__text">${
              genresNames ? genresNames : 'No genres'
            } | ${releaseYear} <span class="rating">${vote_average}</span></p>
        </li>`;
      }
    )
    .join('');
